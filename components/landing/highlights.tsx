...
const moments: {
  ...
  {
    image: "/images/highlights/calabar_carnival.png",
    imageAlt: "Dancers in vibrant, colorful costumes on the streets of Calabar",
    caption: "Main stage, golden hour",
    venue: "Millennium Park",
    size: "wide",
  },
  {
    image: "/images/highlights/super_eagles.png",
    imageAlt: "A football stadium filled with cheering fans waving green and white flags",
    caption: "Crucial World Cup Qualifier",
    venue: "Godswill Akpabio International Stadium",
    size: "tall",
  },
  {
    image: "/images/highlights/detty_december.png",
    imageAlt: "A massive outdoor Afrobeats concert with bright lighting and lasers",
    caption: "Three songs into the encore",
    venue: "Eko Atlantic City",
    size: "wide",
  },
  {
    image: "/images/highlights/lagos_band.png",
    imageAlt: "A local band performing at an intimate outdoor stage with string lights",
    caption: "The warm-up act, side stage",
    venue: "Lagos Island, before doors",
    size: "tall",
  },
  {
    image: "/images/highlights/theatre_play.png",
    imageAlt: "Actors performing a traditional Nigerian play on stage",
